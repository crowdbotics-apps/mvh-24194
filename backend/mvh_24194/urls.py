...
admin.site.site_header = "mvh"
admin.site.site_title = "mvh Admin Portal"
admin.site.index_title = "mvh Admin"

# swagger
api_info = openapi.Info(
    title="mvh API",
    default_version="v1",
    description="API documentation for mvh App",
)
